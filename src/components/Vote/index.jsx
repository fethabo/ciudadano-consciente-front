 ...
 * @returns 
 */
function Vote({entityType, entityId, userVotes, isError, isLoading = false, sxButton}) {
 ...
 */
 ...
 useEffect(() => {
  ...
  //busco el voto y lo seteo en el estado interno
    ...
    return ( 
        <IconButton sx={sxButton} onClick={() => handleVote()} disabled={loader||isError||isErrorEntityTypes}>
                  {(loader)
                  ? <SvgIcon>
